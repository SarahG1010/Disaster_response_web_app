...
def load_data(messages_filepath, categories_filepath):
    ...
    FUNCTION:
    load the original dataset for preprocessing
    """
...
def clean_data(df):
    ...
    # drop the rows with 'related ==2'
    index = categories[categories['related']==2].index
...
def save_data(df, database_filename):
    ...
    database_filename - the filename for the database
    
    OUTPUT:
    none
    
    FUNCTION:
    save the cleaned dataset into a database file
    """
